<?php
                        ...
                        <aside>
                            ...
                            <nav id=\"sender\">
                                ...
                                <ul><li><a href=\"create_package1.html\" > 寄件</a></li><br>
                                    <li><a href=\"search_package.php\"style=\"color:forestgreen\">我的包裹</a></li> <br>
    ...
    $s_phone=$_COOKIE["sender_phone"];
	require("conn_mysql.php");
    $sql_query="SELECT p_no,s_name,s_store,r_name,r_store,shipping_status FROM package where s_name = (SELECT s_name FROM sender where s_phone='$s_phone')";
    ...
    if(mysqli_num_rows($result)){
        ...
        <form method=\"POST\" action=\"search_package_byp_no.php\">
